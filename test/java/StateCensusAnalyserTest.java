...
public class StateCensusAnalyserTest {
    ...
    public void givenCSVFile_shouldReturnNumberOfRecords() {
        int result = csvStateCensus.readStatesCensusCsv("main/resources/StateCensusData.csv").size();
    ...
    public void givenFile_IfIncorrectType_shouldReturnCustomException() throws CensusAnalyserException {
        try {
            int result = csvStateCensus.readStatesCensusCsv("test/java/StateCensusAnalyserTest.txt").size();
        } catch (CensusAnalyserException e) {
    ...
    public void givenFile_IfCorrectTypeButImproperDelimiter_shouldReturnCustomException() throws CensusAnalyserException {
        try {
            int result = csvStateCensus.readStatesCensusCsv("main/resources/StateCensusImproperDelimiter.csv").size();
        } catch (CensusAnalyserException e) {
